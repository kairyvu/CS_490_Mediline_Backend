...
class Appointment(db.Model):
    ...
    patient_id = db.Column(db.Integer, db.ForeignKey('patient.user_id'), nullable=False, opndelete='CASCADE')
...
class AppointmentDetail(db.Model):
    ...
    appointment_id = db.Column(db.Integer, db.ForeignKey('appointment.appointment_id'), nullable=False, ondelete='CASCADE')
